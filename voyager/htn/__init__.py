...
This module provides a modular, fact-based task decomposition and execution
system as an alternative to code generation.
...
Public API:
    ...
    - RecipeFacts: Authoritative game mechanics source
...
Example:
    ...
    orchestrator = HTNOrchestrator(env, facts)
